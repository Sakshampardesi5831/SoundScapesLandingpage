window.onscroll = function(){
   ...
   /* if(top>20){
        ...
        document.querySelector(".Navbar1 Button ").style.backgroundColor = "#FF9100"
        document.querySelector("nav Button ").style.color = "white" 
        document.querySelector("#logo>h5").style.display = "initial"
        document.querySelector('nav').style.backgroundColor="transparent";
    }
    else{
        document.querySelector(".Navbar1").style.position = "initial"
        document.querySelector(".Navbar1 Button ").style.backgroundColor = "white"
        document.querySelector("nav Button ").style.color = "black"
        document.querySelector("#logo>h5").style.display = "none"
    ...
    if(top>20)
    {
        ...
        //   mysong.play(); 
        /*ERROR OCCURED UNCAUGHT PROMISE NOT RETURN THAT WHY AUTOMATIC NOT RETURN*/;
    }
}
...
loop:true,
  ...
  (function (){
    function startSetup( sliderSize, slideSize, animationDuration, autoplayInterval ) {
     ...
     function Slider( newSlider, sliderSize, slideSize, animationDuration, autoplayInterval ) {
         ...
         this.stepAngle            = 2.0*Math.PI/newSlider.querySelectorAll( '.circular-slider .wrapper .slides-holder .slides-holder__item' ).length;
     ...
     Slider.prototype.setSize = function( radius ) {
         ...
         this.slidesSize                        = Math.min( 2*radius*this.startSetup.slideSize, this.stepAngle*radius*( 1 - this.startSetup.slideSize ) - 0);
    ...
    window.circularSlider1 = new Slider( document.querySelector( '.circular-slider-1' ), 140, 30, 600, 3000 );
     window.circularSlider2 = new Slider( document.querySelector( '.circular-slider-2' ), 100, 13, 700, 3000 );
 ...
 var iconStop=document.getElementById("pause_icon");
    //  mysong.play();
    icon.onclick=function(){
        // mysong.play();
        mysong.setAttribute('src','./music/Town Market - Full.mp3');
        mysong.play();
        mysong.volume=0.2;
    ...
    icon.ondblclick=function(){
        mysong.setAttribute('src','./music/Campfire Night - Full Loop.mp3');
        mysong.play();
        mysong.volume=0.2;
    }
 }
